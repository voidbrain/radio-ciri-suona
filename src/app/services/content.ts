  ...
  public readonly pages = signal<Page[]>([
    { id: 1,
      ...
      files: [
        ...
        { id: 10, path: "10 Le dimissioni di Giovanni Leone- interviste al sindaco Antonio Mazzarolli e a cittadini, 1978.mp3", title: "Le dimissioni di Giovanni Leone: interviste al sindaco Antonio Mazzarolli e ai cittadini, 1978" }
    ] },
    ...
    { id: 2,
      ...
      files: [
        ...
        { id: 3, path: "3 Lavoro un ex detenuto_ Intervista a favore, 1977.mp3", title: "Lavoro a un ex detenuto? Intervista a favore, 1977" },
        ...
        { id: 10, path: "10 Lavoratori del circo- intervista a Moira Orfei, 1978.mp3", title: "Lavoratori del circo: intervista a Moira Orfei, 1979" }
    ] },
    { id: 3,
      ...
      files: [
        { id: 1, path: "1 Manifestazione “Riprendiamoci la città” a Mestre- slogan e canti, 1977.mp3", title: 'Manifestazione “Riprendiamoci la città” a Mestre: cori e slogan, 1977', },
    ...
    { id: 5,
      ...
      description1: "Negli anni ’70 la scuola italiana attraversa un processo di democratizzazione che supera gradualmente i retaggi ereditati dal fascismo. Le riforme promuovono il diritto allo studio, l’aggiornamento dei docenti e una maggiore partecipazione. Nascono gli asili nido comunali, il tempo pieno e gli organi collegiali aperti a studenti e famiglie. Si diffondono esperienze di didattica attiva e la “scuola delle 150 ore” consente a centinaia di migliaia di lavoratori di completare la scuola dell’obbligo.",
      description2: "Gli studenti manifestano contro la riforma Malfatti e contro l’autoritarismo di presidi e insegnanti. Le lotte coinvolgono anche i docenti precari, con proteste e blocchi degli scrutini.",
      files: [
        { id: 1, path: "1 Manifestazione studentesca contro la riforma della scuola slogan 1977.mp3", title: 'Manifestazione studentesca contro la riforma della scuola: cori e slogan, 1977', },
        ...
        { id: 4, path: "4 Genitori contro il preside della scuola media Stefanini una denuncia, 1977.mp3", title: "Genitori contro il preside della scuola media Stefanini di Treviso: una denuncia, 1977"},
        { id: 5, path: "5 Esami di maturita interviste agli studenti dell’Istituto magistrale.mp3", title: "Esami di maturità: interviste agli studenti, 1977"},
        { id: 6, path: "6 Esami di maturita interviste agli studenti, 1977.mp3", title: "Esami di maturità: altre interviste, 1977 "},
    ...
    { id: 6,
      ...
      description1: "La musica è centrale nelle radio libere, diventando il linguaggio con cui i giovani esprimono ribellione e desiderio di cambiamento. Le emittenti diffondono rock, pop britannico, progressive, cantautorato, reggae e, dalla seconda metà degli anni ’70, punk e new wave, proponendo una programmazione alternativa a quella della RAI. Accanto agli artisti internazionali trovano spazio musicisti emergenti e repertori locali.",
      description2: "Canzoni di protesta e brani alternativi accompagnano scioperi, dibattiti e trasmissioni dei collettivi di base. La nuova scuola mette al centro l’educazione all’ascolto, alla creatività e alla corporeità delle bambine e dei bambini.",
      files: [
